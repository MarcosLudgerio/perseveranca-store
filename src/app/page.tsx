...
export default async function Home() {
  ...
  return (
    <div className="bg-white min-h-screen flex flex-col">
      ...
      {/* Rodapé */}
      <footer className="bg-[#F7F7F7]  shadow-3xl text-gray-900 px-4 rounded-t-3xl">
        <div
          className="max-w-5xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6 text-center md:text-left">
        ...
        <div className="mt-4 mb-4 border-t border-secondary pt-2 text-center text-sm">
